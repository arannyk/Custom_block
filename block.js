 ...
 *
 * https://github.com/arannyk/Custom_block/
 */
( function() {
	 ...
	 */
	registerBlockType(
		'mon/block-styles-example', // Block name. Must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		{
